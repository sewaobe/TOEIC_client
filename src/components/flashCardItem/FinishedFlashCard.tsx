    ...
    >
      ...
      >
        <CardContent>
          ...
          >
            <Typography variant="h5" fontWeight={800} sx={{ color: '#1a202c' }} gutterBottom>
              {title}
            </Typography>
          </motion.div>
          ...
          >
            ...
            >
              ...
              {onStats && (
                <Button variant="outlined" color="primary" onClick={onStats} sx={{ borderRadius: '12px' }}>
                  Xem thống kê
                </Button>
              )}
              <Button variant="contained" color="secondary" onClick={onRedo} sx={{ borderRadius: '12px', boxShadow: 'none' }}>
                Làm lại
              </Button>
