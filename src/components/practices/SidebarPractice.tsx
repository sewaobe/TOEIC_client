        ...
        {filteredParts.slice(0, 4).map((part, index) => (
          ...
          >
            <AccordionSummary
              ...
              onClick={() => {
                // Click vào Part title → load toàn bộ bài của Part đó
                const partNumber = index + 1;
                onSelectPart?.(partNumber);
              }}
            >
                        ...
                        part.tags.map((tag, i) => (
                          <Chip
                            ...
                            onClick={(e) => {
                              ...
                              // Click vào tag → load bài theo part + tag
                              const partNumber = index + 1;
                              onSelectTagFilter?.(partNumber, tag);
                            }}
                          />
                        ))
                      ) : (
        ...
        {filteredParts.slice(4).map((part, index) => (
          ...
          >
            <AccordionSummary
              ...
              onClick={() => {
                // Click vào Part title → load toàn bộ bài của Part đó (Part 5-7)
                const partNumber = index + 5;
                onSelectPart?.(partNumber);
              }}
            >
              <Box display="flex" alignItems="center" gap={1}>
                        ...
                        part.tags.map((tag, i) => (
                          <Chip
                            ...
                            onClick={(e) => {
                              ...
                              // Click vào tag → load bài theo part + tag (Part 5-7)
                              const partNumber = index + 5;
                              onSelectTagFilter?.(partNumber, tag);
                            }}
                          />
