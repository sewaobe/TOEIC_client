...
import { ensureWeekLessons, readCurrentLesson, saveCurrentLesson, saveWeekLessons } from "../../utils/lessonStorage";
                    ...
                    <Grid container spacing={2}>
                                            ...
                                            <LessonIntroExam
                                                ...
                                                onStart={() => {
                                                    ...
                                                    requestAnimationFrame(() => {
                                                        document.getElementById("exam-questions")?.scrollIntoView({
                                                            behavior: "smooth",
                                                            block: "start",
                                                        });
                                                    });
                        ...
                        <Grid size={{ xs: 12, md: 4 }}>
                            {(!lesson ||
                                lesson?.type === "core" ||
                                ((lesson?.type === "quiz" || lesson?.type === "mini") && !examStarted)) && (
                                    <LessonSidebar lessons={lessons} lesson={lesson} goToLesson={goToLesson} />
                                )}
