...
const PracticeDefinitionBasedDetailPage = () => {
  ...
  const [showVietnameseTranslation, setShowVietnameseTranslation] =
    useState(false);

  // Reset translation toggle khi chuyển sang từ khác
  useEffect(() => {
                  ...
                  {hasAttemptedCurrent && (
                    ...
                    >
                      ...
                      <Typography sx={{ mt: 1.5 }}>
                        ...
                        {vocab.definition_en || "Chưa có dữ liệu định nghĩa."}
                      </Typography>

                      {(vocab as any).definition_vi && (
                        <Box sx={{ mt: 1 }}>
                          <Button
                            size="small"
                            variant="outlined"
                            onClick={() =>
                              setShowVietnameseTranslation(
                          ...
                          <Collapse in={showVietnameseTranslation}>
                            <Typography
                              sx={{
                                mt: 1,
                                p: 1.5,
