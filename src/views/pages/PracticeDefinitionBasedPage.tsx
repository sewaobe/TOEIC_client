        ...
        <PracticeLayout>
            ...
            >
                ...
                <Typography variant="body1" color="text.secondary" sx={{ maxWidth: 800 }}>
                    Hãy chọn một chủ đề để xem các bài học. Trong mỗi bài, bạn sẽ thử định nghĩa lại
                    từ vựng bằng chính ngôn ngữ của mình để hệ thống kiểm tra độ hiểu và gợi ý khi cần.
                </Typography>
            </Box>
